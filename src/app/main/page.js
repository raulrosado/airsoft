  ...
  return (
    ...
    <div className="bg-gray-900">
      ...
      <div className="relative isolate overflow-hidden pt-14">
        ...
        /> */}
        <video src="video.mp4" autoPlay loop muted playsInline className="absolute inset-0 -z-10 h-full w-full object-cover"/>
        <div
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Animate a unirte a este bello hobby lleno de adrenalina
            </p>
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              ...
              <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
                <div className="w-0 flex-auto lg:ml-auto lg:w-auto lg:flex-none lg:self-end">
                  <img
                    src="simplementeairsoft_385885992_309592211773279_3634208780565052674_n.jpeg"
                    alt=""
                ...
                <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-[37rem] lg:items-start lg:justify-end lg:gap-x-8">
                  <div className="order-first flex w-64 flex-none justify-end self-end lg:w-auto">
                    <img
                      src="simplementeairsoft_418392917_917743956539526_919365459582018435_n.jpeg"
                      alt=""
                  ...
                  <div className="flex w-96 flex-auto justify-end lg:w-auto lg:flex-none">
                    <img
                      src="simplementeairsoft_424896477_385547547456456_1962204889904956368_n.jpeg"
                      alt=""
                  ...
                  <div className="hidden sm:block sm:w-0 sm:flex-auto lg:w-auto lg:flex-none">
                    <img
                      src="368150057_3110454105928518_4656086164991471611_n.jpeg"
                      alt=""
    ...
    <section>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Campa;as activas</h2>
